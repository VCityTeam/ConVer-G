...
curl --location 'http://localhost:8080/import/version' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/GratteCiel_2009_alt_split.ttl"'
...
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/GratteCiel_2009_2018_Workspace.ttl"'
...
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2009_2009b.ttl"'

echo "[SPARQL-to-SQL] Transition Transition_2009_2012."
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2009_2012.ttl"'

echo "[SPARQL-to-SQL] Transition Transition_2009b_2012b."
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2009b_2012b.ttl"'

echo "[SPARQL-to-SQL] Transition Transition_2012_2015."
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2012_2015.ttl"'

echo "[SPARQL-to-SQL] Transition Transition_2012b_2015."
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2012b_2015.ttl"'

echo "[SPARQL-to-SQL] Transition Transition_2015_2018."
curl --location 'http://localhost:8080/import/workspace' \
  --header 'Content-Type: multipart/form-data' \
  --form 'file=@"quads/named_graph/Transition_2015_2018.ttl"'
