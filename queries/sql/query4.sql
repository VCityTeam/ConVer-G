SELECT 'named_graph' as type, vq1.id_named_graph as graph, COUNT(rl1.name) as number
...
(
    ...
    SELECT 'version' as type, position as graph, COUNT(name) as number
