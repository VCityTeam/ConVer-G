...
FROM (
     ...
     FROM (
              SELECT t1.id_subject as v$s1, t2.id_subject as v$s2, t1.id_predicate as v$p1, t2.id_predicate as v$p2, t1.id_object as v$o1, t2.id_object as v$o2, vng1.id_versioned_named_graph as v$vg1
